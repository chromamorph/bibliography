...
These functions enable the formation of unions and
intersections over lists that represent finite sets in
$n$-dimensional space. It is also possible to find
translators of a pattern in a dataset. |#
...
asc is applied recursively to a list of $k$-
dimensional vector sets. |#
