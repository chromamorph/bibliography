...
% function for evaluating the algorithm output against a ground truth.
...
for istruct = 1:nstruct
  ...
  % Get the anchors for each inexact occurrence of the pattern. If there
  % are no inexact occurrences then this loop will not execute as occm = 0.
  for occi = 1:occm
